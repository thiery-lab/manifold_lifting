...
parser = argparse.ArgumentParser(
    description="Run autoregressive-K (AR-K) benchmark model experiment"
)
parser.add_argument(
    "--output-root-dir",
    default="results",
...
output_dir = os.path.join(args.output_root_dir, "ar_k", dir_name)
...
summary_vars = ["α", "β", "σ", "hamiltonian"]
